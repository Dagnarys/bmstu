    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 12, 20, 7, 37, 42, 792372, tzinfo=datetime.timezone.utc), verbose_name='Дата начала')),
                ('end_date', models.DateField(default=datetime.datetime(2024, 12, 19, 7, 37, 42, 792392, tzinfo=datetime.timezone.utc), verbose_name='Дата конца')),
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2023, 12, 20, 7, 37, 42, 792418, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
